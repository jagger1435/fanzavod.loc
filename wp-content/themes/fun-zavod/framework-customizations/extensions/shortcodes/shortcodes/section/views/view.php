...
?>
<section<?php echo $customId ?> class="fw-main-row<?php echo $customClass ?> <?php echo esc_attr($section_extra_classes) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
